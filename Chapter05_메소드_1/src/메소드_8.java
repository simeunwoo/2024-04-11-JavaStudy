...
public class 메소드_8 {
	...
	/*
	 * 		int add(int a,int b) => 가급적이면 같은 데이터형을 써라
	 * 
	 * 		=> int a=add(int,int) => byte/char 가능
	 * 		   ---
	 * 		   long/float/double 가능
	 */
 ...
 */
		 ...
		 */
//		int r=Math.random(); // 오류 => 리턴형이 double이기 때문
		double r=Math.random(); // 매개변수 X 
		// double java.lang.Math.random()
		System.out.println(r); // 0.9130610744722134 (랜덤값)
