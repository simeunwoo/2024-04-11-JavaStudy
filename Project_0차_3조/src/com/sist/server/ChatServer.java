				...
				while(true)
				{
					...
					switch(delimit)
					{
					   ...
					   case Function.ONEYES:
					   {
						   ...
						   for(Client client : waitVc) {
							   if(userId.equals(client.id)) {
								   client.messageTo(Function.ONEYES + "|" + id);
								   messageTo(Function.ONEYES + "|" + userId);
							   }
						   }
					   }
					   break;
					   case Function.ONETOONE:{
						   ...
						   for(Client client : waitVc) {
							   if(userId.equals(client.id))
							   {
								   client.messageTo(Function.ONETOONE+"|["+name+"]"+msg);// 상담 받는 사람 
								   messageTo(Function.ONETOONE+"|["+name+"]"+msg);// 상담자 
							   }
						   }
					   }
					   break;
